...
# Exemplo de uso
nomes = ["Andrea Souza Santos", "Elinaldo Machado Ramos", "Elinaldo Machado Ramos", "Carlas Mari Brito de Jesus", "Camila Lima da Cruz", "Luana Guimarães Sobral", "Luzia Maria Pires Montenegro"]
